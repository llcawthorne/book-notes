...
--   '.html' files in the process. Recording unsuccessful reads and writes
--   to stderr.
--
...
-- | Write files toa  directory, recording errors to stderr.
...
-- | Try to apply an IO function of a list of values, document successes and failures
