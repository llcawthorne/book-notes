...
sanityCheck :: Spec
sanityCheck = do
  describe "To test parallel execution" $ do
    it "sleeps 1" $ threadDelay (2 * 1000000) `shouldReturn` ()
    it "sleeps 2" $ threadDelay (2 * 1000000) `shouldReturn` ()
