...
func getOneHandler(w http.ResponseWriter, r *http.Request, list *todo.List,
	id int) {
...
func deleteHandler(w http.ResponseWriter, r *http.Request, list *todo.List,
	id int, todoFile string) {
...
func patchHandler(w http.ResponseWriter, r *http.Request, list *todo.List,
	id int, todoFile string) {
