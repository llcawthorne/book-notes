...
def print_chess_board(board):
    ...
    for y in "87654321":
        for x in "abcdefgh":
            ...
            # Remember x and y are strings, so x + y is string concatenation
            ...
            # toggle after each square, since white/black alternate
            is_white_square = not is_white_square
        # Toggle after each row to start correct color
        is_white_square = not is_white_square
